...
def exercise_function(sequence_codons): #Input is the sequence of codons 
    """What does this function do?""" #Translates the mRNA sequence into Amino Acids based on the codons
    aa_string = ""
